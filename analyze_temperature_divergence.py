...
| 表达丰富度 | {(all_data['0.0']['style']['语气词'] + all_data['0.0']['style']['具体例子'])/10:.1f} | {(all_data['0.5']['style']['语气词'] + all_data['0.5']['style']['具体例子'])/10:.1f} | {(all_data['1.0']['style']['语气词'] + all_data['1.0']['style']['具体例子'])/10:.1f} |
